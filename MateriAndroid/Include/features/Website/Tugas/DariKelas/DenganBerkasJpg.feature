Feature: Testing feature tambah Tugas dari dashboard Website Edlink
  ...
  Scenario Outline: User login dengan akun siakad
    ...
    Given Dosen memilih berkas jpg di media library
    When Dosen tap pilih di pop up media library
    Then Dosen melihat media jpg telah terpilih di pop up atur tugas
...
############################# Mahasiswa ##############################
    ...
    And Mahasiswa dapat melihat dokumen jpg di detail tugas
...
#### MENILAI TUGAS
    ...
    And Dosen melihat berkas jpg tugas mahasiswa di detail jawaban mahasiswa
