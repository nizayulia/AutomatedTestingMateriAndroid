Feature: Testing feature tambah Materi dari kelas di Website Edlink
  ...
  Scenario Outline: User login dengan akun siakad
    ...
    Then Dosen melihat media jpg telah terpilih di pop up atur materi
...
############################# Mahasiswa ##############################
    ...
    And Mahasiswa dapat melihat dokumen jpg di detail materi
